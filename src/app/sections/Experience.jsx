...
const EDUCATION = [
    ...
    },
    {
        ...
        date: "2023",
        link: 'https://www.udemy.com/course/aprende-javascript-es9-html-css3-y-nodejs-desde-cero/?couponCode=ACCAGE0923'
    },
    {
...
const EducationItem = (props) => {
    ...
    return (
        <>
            ...
            <time className="mb-1 text-base font-normal leading-none text-gray-400 dark:text-gray-400">{props.date} - {props.institution}</time>
            <h3 className="text-xl font-semibold text-gray-900 dark:text-white">{props.courseName}</h3>
            <p className="mb-4 text-lg font-normal text-gray-500 dark:text-gray-300">{props.description}</p>
            {props.link && (
                <a href={props.link} target='_blank' className="inline-flex items-center px-4 py-2 text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg hover:bg-gray-100 hover:text-blue-700 focus:z-10  focus:outline-none  focus:text-blue-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">Conocer más<svg className="w-3 h-3 ms-2 rtl:rotate-180" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
