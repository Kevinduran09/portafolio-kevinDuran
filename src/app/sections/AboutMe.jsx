        ...
        <div className="w-full p-5">
            ...
            <div className='px-6'>
                <p className='text-lg  leading-6 mb-4'>
                    Soy Kevin Durán, estudiante de Ingeniería de software, apasionado por la Tecnologia. <span className='text-fuchsia-500'>Con experiencia en diversas tecnologías y lenguajes de programación.</span> Me gusta aprender y estar en constante crecimiento.
                </p>
                <p className='text-lg  leading-6 mb-4'>
                ...
                <span className='flex items-center gap-2 mt-6 text-gray-500 dark:text-gray-400'>
                ...
                <ul className='flex flex-row flex-wrap gap-5 py-4'>
                    {SKILLS.map((skill, index) => (
                        <li key={skill} className='flex items-center gap-2 px-3 py-1.5 bg-gray-100 dark:bg-gray-800 rounded-full'>
                ...
                <ul className='flex flex-row flex-wrap gap-5 py-4'>
                    {STACKS.map((stack, index) => (
                        <li key={stack} className='flex items-center gap-2 px-3 py-1.5 bg-gray-100 dark:bg-gray-800 rounded-full'>
