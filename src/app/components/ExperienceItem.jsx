    ...
    return (
        <>
            ...
            <div className='space-y-2'>
                <time className="mb-3 text-base font-normal leading-none text-fuchsia-400">{props.date}</time>
                <h3 className="text-2xl font-semibold text-white">{props.title}</h3>
                <span className='mb-3 text-xl font-normal text-fuchsia-400'>{props.institution}</span>
